...
void movimientoTren(Item*** matriz, Jugador* jugador){
    ...
    while (true){
        ...
        if ( ( (posicionX >=0 && posicionY >=0) && (posicionX < 13 && posicionY < 11) )   && (direccion>=1 && direccion<=4) ){
            ...
            if(posicionY== 2 && posicionX== 4){
                matriz[2][4] = new Item();
                matriz[2][4]->setSalida("U");
                for(int i=0; i<11; i++){
                    for(int j = 0; j<13; j++){
                        if (( j%2!=0 && i%2!=0)){    
                            matriz[i][j]->setSalida("@");
                ...
                matriz[6][4] = new Item();
                matriz[6][4] = jugador;
                matriz[6][4]->setSalida("*");
                posicionY = 6;
                posicionX = 4;
                impresion(matriz);
            }// if volver

            if(posicionY== 7 && posicionX== 4){
                matriz[7][4] = new Item();
                matriz[7][4]->setSalida("U");
                for(int i=0; i<11; i++){
                    for(int j = 0; j<13; j++){
                        if (( j%2!=0 && i%2!=0)){    
                            matriz[i][j]->setSalida("@");
